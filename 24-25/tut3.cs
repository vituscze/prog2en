...
namespace ConsoleApp1
{
  ...
  // Queue //
  //
  // Write a class Queue implementing a queue of integers. A queue should have an unlimited size.
  // The Queue class should have these members:
  //
  //   Queue()
  //
  //   bool isEmpty()
